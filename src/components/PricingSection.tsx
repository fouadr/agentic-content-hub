...
const plans = [
  {
    ...
    features: ["5 AI-generated posts/week", "2 social accounts", "Basic analytics", "Community support", "API pass (extra cost)", "7-agent AI campaign pipeline", "Campaign review + approval", "Competitor analysis"],
    cta: "Get Started",
    popular: false,
    addons: [
